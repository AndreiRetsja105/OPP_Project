...
public class FrontMainPage extends javax.swing.JFrame {
    ...
    public FrontMainPage() {
     ...
     /**
     * Retrieves messages for a given user from the database.
     * 
     * @param userName The username for which messages are retrieved.
  ...
  /**
    ...
    // Your existing loginUser method
public String loginUser(String userName, String password) {
    ...
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt){
        ...
        if (nameTF.getText().isEmpty()) {
            ...
            String password = passwordTF.getText();
             String loggedInUserName = loginUser(userName, password);

            try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hermes", "root", "");
                    Statement st = con.createStatement()) {
                
                String que = "SELECT * FROM users WHERE userName='" + userName + "' AND password='" + password + "'";
               ...
               if (loggedInUserName != null) {
                    ...
                    JOptionPane.showMessageDialog(null, "Login successful");
                     ...
                     // if user successful it will open the Message form 
                     FrameForPanelsOpen ffpo = new FrameForPanelsOpen ();
                     ffpo.setVisible(true);
                     this.setVisible(false);         
                } else {
                    // User does not exist, show an appropriate message
    ...
    private void showPasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showPasswordActionPerformed
     ...
     // Handle actions when Enter is pressed in the username field
    ...
    // Navigate to the user profile creation form
    ...
    // Handle actions when Enter is pressed in the password field
    private void passwordTFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_passwordTFActionPerformed
        // TODO add your handling code here:
        char[] passwordChars = passwordTF .getPassword();
        String senderPassword = new String(passwordChars);
    ...
    private void displayMessages(List<String> userMessages) {
