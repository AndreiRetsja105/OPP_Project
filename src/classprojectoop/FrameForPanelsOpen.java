...
public class FrameForPanelsOpen extends javax.swing.JFrame {
   ...
   /**
     ...
     * 
     * @param buttonToShow The button to be shown.
     * @param messagesBtn1 The Messages button.
     * @param newsFeedBtn1 The NewsFeed button.
     * @param groupsBtn1 The Groups button.
     * @param exitBtn1 The Exit button.
     */
    
      // Method to hide all buttons except a specified 
   private void hideAllButtonsExcept(JButton buttonToShow, JButton messagesBtn1, JButton newsFeedBtn1, JButton groupsBtn1, JButton exitBtn1) {
    // Hide all buttons except inOutBtn
     ...
     * 
     * @param isLoggedIn Boolean indicating whether a user is logged in.
     */
    ...
    public FrameForPanelsOpen() {
        try {
            ...
            Logger.getLogger(FrameForPanelsOpen.class.getName()).log(Level.SEVERE, null, ex);
        }
        initComponents();
    ...
    hideAllButtonsExcept(profilesBtn, messagesBtn, newsFeedBtn, groupsBtn, exitBtn);
    
    // Add the MainPageImage to the desktopPanel
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameForPanelsOpen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameForPanelsOpen().setVisible(true);
            }
        });
    }
